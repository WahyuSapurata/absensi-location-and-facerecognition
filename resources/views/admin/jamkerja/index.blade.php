...
@section('script')
    <script>
        ...
        $(document).on('click', '#button-side-form', function() {
            control.overlay_form('Tambah', 'Jam Kerja');
        })
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'add') {
                control.submitFormMultipartData('/admin/add-jamkerja', 'Tambah',
                    'Jam Kerja',
                    'POST');
            } else {
                let uuid = $("input[name='uuid']").val();
                control.submitFormMultipartData('/admin/update-jamkerja/' + uuid, 'Update',
                    'Jam Kerja', 'POST');
            }
        });
        ...
        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            let url = '/admin/show-jamkerja/' + $(this).attr('data-uuid');
            control.overlay_form('Update', 'Jam Kerja', url);
        })

        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/admin/delete-jamkerja/' + $(this).attr('data-uuid');
        ...
        let columnDefs = [{
            ...
            render: function(data, type, full, meta) {
                ...
                <a href="javascript:;" type="button" data-uuid="${data}" data-label="Jam Kerja" class="btn btn-danger button-delete btn-icon btn-sm">
        ...
        $(function() {
            control.push_select3(hari, '#hari_select');
            control.initDatatable('/admin/get-jamkerja', columns, columnDefs);
        })
    </script>
@endsection
