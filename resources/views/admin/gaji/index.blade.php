            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data" enctype="multipart/form-data">
                    ...
                    <div class="mb-10">
                        ...
                        <select name="uuid_user" class="form-select" data-control="select2" id="uuid_user_select"
                            data-placeholder="Pilih jenis inputan">
                        </select>
                        <small class="text-danger uuid_user_error"></small>
                    </div>

                    <div class="mb-10">
                        <label class="form-label">Jumlah Gaji</label>
                        <input type="text" id="jumlah_gaji" class="form-control kt_datepicker_8" name="jumlah_gaji">
                        <small class="text-danger jumlah_gaji_error"></small>
                    </div>
...
@section('script')
    <script>
        ...
        $(document).on('click', '#button-side-form', function() {
            control.overlay_form('Tambah', 'Gaji');
        })
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'add') {
                control.submitFormMultipartData('/admin/add-gaji', 'Tambah',
                    'Gaji',
                    'POST');
            } else {
                let uuid = $("input[name='uuid']").val();
                control.submitFormMultipartData('/admin/update-gaji/' + uuid, 'Update',
                    'Gaji', 'POST');
            }
        });
        ...
        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            let url = '/admin/show-gaji/' + $(this).attr('data-uuid');
            control.overlay_form('Update', 'Gaji', url);
        })

        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/admin/delete-gaji/' + $(this).attr('data-uuid');
        ...
        let columns = [{
            ...
            className: 'text-center',
            render: function(data, type, row, meta) {
                const value = numeral(row.jumlah_gaji).format('0,0'); // Format to rupiah
                return 'Rp' + value;
            }
        }, {
            data: 'uuid',
        ...
        let columnDefs = [{
            ...
            render: function(data, type, full, meta) {
                ...
                <a href="javascript:;" type="button" data-uuid="${data}" data-label="GajiKerja" class="btn btn-danger button-delete btn-icon btn-sm">
        ...
        $(function() {
            control.push_select2('/admin/get-dataguru', '#uuid_user_select');
            control.initDatatable('/admin/get-gaji', columns, columnDefs);
        })
    </script>
@endsection
